...
void atExit(int signum) {
  StackFrame sf = NULL;
  math_library_Math_Thread_i_App_atExit(sf);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "Math_Thread_i_App.scala", "math_library.Math_Thread_i_App", "<App>", 0);
  ...
  return (int) math_library_Math_Thread_i_App_main(sf, &t_args);
}