...
Unit art_Art_m_register(StackFrame caller, art_Bridge bridge) {
  ...
  if (!match_32) {
    ...
    if (match_32) {
      ...
      math_library_ArtNix_logInfo(sf, (String) art_Art_logTitle(sf), (String) ((String) &t_3));
    }
  }
  if (!match_32) {
    match_32 = T;
    ...
    if (match_32) {
      ...
      math_library_ArtNix_logInfo(sf, (String) art_Art_logTitle(sf), (String) ((String) &t_5));
    }
  }
    ...
    for (int8_t t_20 = 0; t_20 < t_19; t_20++) {
      ...
      if (!match_40) {
        ...
        if (match_40) {
          ...
          math_library_ArtNix_logInfo(sf, (String) art_Art_logTitle(sf), (String) ((String) &t_9));
        }
      }
      if (!match_40) {
        match_40 = T;
        ...
        if (match_40) {
          ...
          math_library_ArtNix_logInfo(sf, (String) art_Art_logTitle(sf), (String) ((String) &t_11));
        }
      }
      if (!match_40) {
        match_40 = T;
        ...
        if (match_40) {
          ...
          math_library_ArtNix_logInfo(sf, (String) art_Art_logTitle(sf), (String) ((String) &t_13));
        }
      }
      if (!match_40) {
        match_40 = T;
        ...
        if (match_40) {
          ...
          math_library_ArtNix_logInfo(sf, (String) art_Art_logTitle(sf), (String) ((String) &t_15));
        }
      }
...
Unit art_Art_connect(StackFrame caller, art_UPort from, art_UPort to) {
  ...
  String_string((String) &t_1, sf, string(""));
  math_library_ArtNix_logInfo(sf, (String) art_Art_logTitle(sf), (String) ((String) &t_1));
}
...
Unit art_Art_receiveInput(StackFrame caller, IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(55);
  math_library_ArtNix_receiveInput(sf, (IS_82ABD8) eventPortIds, (IS_82ABD8) dataPortIds);
}
...
Unit art_Art_sendOutput(StackFrame caller, IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(67);
  math_library_ArtNix_sendOutput(sf, (IS_82ABD8) eventPortIds, (IS_82ABD8) dataPortIds);
}
...
Unit art_Art_logInfo(StackFrame caller, Z bridgeId, String msg) {
  ...
  math_library_ArtNix_logInfo(sf, (String) ((String) &t_1), (String) msg);
}
