...
object Arch {
  val BuildingControlDemo_i_Instance_tcp_tempSensor : bc.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge = {
    val currentTemp = Port[BuildingControl.Temperature_i] (id = portId"0", name = "BuildingControlDemo_i_Instance_tcp_tempSensor_currentTemp", mode = DataOut)
  ...
  val BuildingControlDemo_i_Instance_tcp_tempControl : bc.BuildingControl.TempControl_i_tcp_tempControl_Bridge = {
    val currentTemp = Port[BuildingControl.Temperature_i] (id = portId"2", name = "BuildingControlDemo_i_Instance_tcp_tempControl_currentTemp", mode = DataIn)
    ...
    val setPoint = Port[BuildingControl.SetPoint_i] (id = portId"4", name = "BuildingControlDemo_i_Instance_tcp_tempControl_setPoint", mode = EventIn)
