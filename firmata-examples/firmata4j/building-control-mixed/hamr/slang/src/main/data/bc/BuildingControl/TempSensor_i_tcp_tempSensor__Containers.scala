...
@sig trait TempSensor_i_tcp_tempSensor_PreState_Container extends art.DataContent {
}
...
@sig trait TempSensor_i_tcp_tempSensor_PostState_Container extends art.DataContent {
...
@datatype class TempSensor_i_tcp_tempSensor_PostState_Container_P (
  ...
  val api_currentTemp: BuildingControl.Temperature_i) extends TempSensor_i_tcp_tempSensor_PostState_Container
