...
class SystemTests extends SystemTestSuite {
  ...
  // import bc.BuildingControl.{TempSensor_i_tcp_tempSensor_SystemTestAPI => nickname}
  // import bc.BuildingControl.{TempControl_i_tcp_tempControl_SystemTestAPI => nickname}
  // import bc.BuildingControl.{Fan_i_tcp_fan_SystemTestAPI => nickname}
