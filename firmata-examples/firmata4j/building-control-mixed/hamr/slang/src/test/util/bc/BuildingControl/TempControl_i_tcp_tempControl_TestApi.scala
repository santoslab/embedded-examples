...
@msig trait TempControl_i_tcp_tempControl_TestApi {
  ...
  def put_setPoint(value : BuildingControl.SetPoint_i): Unit = {
    Art.insertInInfrastructurePort(Arch.BuildingControlDemo_i_Instance_tcp_tempControl.operational_api.setPoint_Id, BuildingControl.SetPoint_i_Payload(value))
  }
