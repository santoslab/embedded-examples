...
//     sireum proyek run . offon.Demo
//
//   To see the available CLI options:
//     sireum proyek run . offon.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main offon.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/offon/Demo.scala and choose "Run 'Demo'"
//
...
// add hardwareLibs to project.cmd
val hardwareLibs: ISZ[String] = ISZ[String](
  "com.github.kurbatov:firmata4j:",
  "com.fazecast:jSerialComm:") ++ (
  if (Os.isWin || Os.prop("os.arch") == Some("aarch64"))
    ISZ("io.github.java-native:jssc:")
  else ISZ())

val slangModule: Module = Module(
  id = "OffOnDemo_i_Instance",
  basePath = (home / "src").string,
  subPathOpt = None(),
  deps = ISZ(),
  targets = ISZ(Target.Jvm),

  // change ivyDeps so that it matches line 75
  //ivyDeps = ISZ("org.sireum.kekinian::library:"),
  ivyDeps = ISZ[String]("org.sireum.kekinian::library:") ++ hardwareLibs,
