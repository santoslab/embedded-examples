...
val files: ISZ[String] = ISZ("../src/main/data/offon/Base_Types.scala",
                             "../src/main/art/art/DataContent.scala",
                             "../src/main/data/offon/Aux_Types.scala")

val toolargs: String = st"${(files, " ")}".render

proc"$sireum tools sergen -p offon -m json,msgpack -o ${Os.slashDir.up}/src/main/data/offon $toolargs".at(Os.slashDir).console.runCheck()
