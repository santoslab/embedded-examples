...
object Schedulers {
  ...
  val OffOnDemo_i_Instance_p_on_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())

  val OffOnDemo_i_Instance_p_off_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())
  ...
  val staticSchedule: DScheduleSpec = DScheduleSpec(0, 0, DSchedule(ISZ(
    Slot(Arch.OffOnDemo_i_Instance_p_on.id, maxExecutionTime),
    Slot(Arch.OffOnDemo_i_Instance_p_off.id, maxExecutionTime)
  )))
