...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  building_control_Fan_i_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "Fan_i_App.scala", "building_control.Fan_i_App", "<App>", 0);
  ...
  return (int) building_control_Fan_i_App_main(SF &t_args);
}