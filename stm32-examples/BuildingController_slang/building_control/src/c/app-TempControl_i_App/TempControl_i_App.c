...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  building_control_TempControl_i_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "TempControl_i_App.scala", "building_control.TempControl_i_App", "<App>", 0);
  ...
  return (int) building_control_TempControl_i_App_main(SF &t_args);
}