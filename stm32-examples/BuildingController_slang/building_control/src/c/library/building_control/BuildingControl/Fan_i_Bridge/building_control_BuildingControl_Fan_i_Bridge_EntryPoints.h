...
static inline B building_control_BuildingControl_Fan_i_Bridge_EntryPoints__ne(building_control_BuildingControl_Fan_i_Bridge_EntryPoints this, building_control_BuildingControl_Fan_i_Bridge_EntryPoints other) {
...
#define building_control_BuildingControl_Fan_i_Bridge_EntryPoints__is(sf, this) (((building_control_BuildingControl_Fan_i_Bridge_EntryPoints) this)->type == Tbuilding_control_BuildingControl_Fan_i_Bridge_EntryPoints)

static inline building_control_BuildingControl_Fan_i_Bridge_EntryPoints building_control_BuildingControl_Fan_i_Bridge_EntryPoints__as(StackFrame caller, void *this) {
  ...
  fprintf(stderr, "Invalid case from %s to building_control.BuildingControl.Fan_i_Bridge.EntryPoints.", TYPE_string(this));
  sfAbortImpl(caller, "");
  abort();
}
