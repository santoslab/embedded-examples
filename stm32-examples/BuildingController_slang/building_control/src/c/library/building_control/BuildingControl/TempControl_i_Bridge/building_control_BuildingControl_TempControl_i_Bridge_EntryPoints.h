...
inline B building_control_BuildingControl_TempControl_i_Bridge_EntryPoints__ne(building_control_BuildingControl_TempControl_i_Bridge_EntryPoints this, building_control_BuildingControl_TempControl_i_Bridge_EntryPoints other) {
...
inline B building_control_BuildingControl_TempControl_i_Bridge_EntryPoints__is(STACK_FRAME void* this) {
  return ((building_control_BuildingControl_TempControl_i_Bridge_EntryPoints) this)->type == Tbuilding_control_BuildingControl_TempControl_i_Bridge_EntryPoints;
}

inline building_control_BuildingControl_TempControl_i_Bridge_EntryPoints building_control_BuildingControl_TempControl_i_Bridge_EntryPoints__as(STACK_FRAME void *this) {
  ...
  fprintf(stderr, "Invalid case from %s to building_control.BuildingControl.TempControl_i_Bridge.EntryPoints.", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
