...
inline B building_control_BuildingControl_TempSensor_i_Bridge_Api__ne(building_control_BuildingControl_TempSensor_i_Bridge_Api this, building_control_BuildingControl_TempSensor_i_Bridge_Api other) {
...
inline B building_control_BuildingControl_TempSensor_i_Bridge_Api__is(STACK_FRAME void* this) {
  return ((building_control_BuildingControl_TempSensor_i_Bridge_Api) this)->type == Tbuilding_control_BuildingControl_TempSensor_i_Bridge_Api;
}

inline building_control_BuildingControl_TempSensor_i_Bridge_Api building_control_BuildingControl_TempSensor_i_Bridge_Api__as(STACK_FRAME void *this) {
  ...
  fprintf(stderr, "Invalid case from %s to building_control.BuildingControl.TempSensor_i_Bridge.Api.", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
