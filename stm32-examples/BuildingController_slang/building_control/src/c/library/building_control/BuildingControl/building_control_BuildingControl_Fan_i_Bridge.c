...
void building_control_BuildingControl_Fan_i_Bridge_string(String result, StackFrame caller, building_control_BuildingControl_Fan_i_Bridge this) {
  ...
  String_string(result, sf, string("Fan_i_Bridge("));
  String sep = string(", ");
...
void building_control_BuildingControl_Fan_i_Bridge_apply(StackFrame caller, building_control_BuildingControl_Fan_i_Bridge this, Z id, art_DispatchPropertyProtocol dispatchProtocol, art_Port_69270F fanCmd) {
  ...
  t_1.size = (int8_t) 1;
  Type_assign(&t_1.value[0], building_control_BuildingControl_Fan_i_Bridge_fanCmd_(this), sizeof(union art_UPort));
  ...
  t_4.size = (int8_t) 1;
  Type_assign(&t_4.value[0], building_control_BuildingControl_Fan_i_Bridge_fanCmd_(this), sizeof(union art_UPort));
  STATIC_ASSERT(0 <= MaxIS_820232, "Insufficient maximum for IS[Z, art.UPort] elements.");
