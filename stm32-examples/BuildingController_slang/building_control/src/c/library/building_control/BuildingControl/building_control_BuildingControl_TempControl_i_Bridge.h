...
static inline B building_control_BuildingControl_TempControl_i_Bridge__ne(building_control_BuildingControl_TempControl_i_Bridge this, building_control_BuildingControl_TempControl_i_Bridge other) {
...
#define building_control_BuildingControl_TempControl_i_Bridge__is(sf, this) (((building_control_BuildingControl_TempControl_i_Bridge) this)->type == Tbuilding_control_BuildingControl_TempControl_i_Bridge)

static inline building_control_BuildingControl_TempControl_i_Bridge building_control_BuildingControl_TempControl_i_Bridge__as(StackFrame caller, void *this) {
  ...
  fprintf(stderr, "Invalid case from %s to building_control.BuildingControl.TempControl_i_Bridge.", TYPE_string(this));
  sfAbortImpl(caller, "");
  abort();
}
