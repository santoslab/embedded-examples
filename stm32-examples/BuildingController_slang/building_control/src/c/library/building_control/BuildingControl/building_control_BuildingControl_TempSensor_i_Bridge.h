...
inline B building_control_BuildingControl_TempSensor_i_Bridge__ne(building_control_BuildingControl_TempSensor_i_Bridge this, building_control_BuildingControl_TempSensor_i_Bridge other) {
...
inline B building_control_BuildingControl_TempSensor_i_Bridge__is(STACK_FRAME void* this) {
  return ((building_control_BuildingControl_TempSensor_i_Bridge) this)->type == Tbuilding_control_BuildingControl_TempSensor_i_Bridge;
}

inline building_control_BuildingControl_TempSensor_i_Bridge building_control_BuildingControl_TempSensor_i_Bridge__as(STACK_FRAME void *this) {
  ...
  fprintf(stderr, "Invalid case from %s to building_control.BuildingControl.TempSensor_i_Bridge.", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
