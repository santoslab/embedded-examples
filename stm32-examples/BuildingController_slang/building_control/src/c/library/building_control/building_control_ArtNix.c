...
void building_control_ArtNix_init(StackFrame caller) {
  ...
  _building_control_ArtNix_maxPortIds = Z__add(building_control_IPCPorts_Main(sf), Z_C(1));
  ...
  MS_2590FE_create((MS_2590FE) &t_2, sf, building_control_ArtNix_maxPortIds(sf), (Option_8E9F45) (&t_1));
  ...
  MS_B5E3E6_create((MS_B5E3E6) &t_5, sf, building_control_ArtNix_maxPortIds(sf), (IS_AA0F82) (&t_4));
  ...
  Tuple2_EC3B57_apply(sf, &t_7, building_control_IPCPorts_TempControl_i_App(sf), art_Port_C61295_id_(building_control_BuildingControl_TempControl_i_Bridge_currentTemp_(building_control_Arch_BuildingControlDemo_i_Instance_tcp_tempControl(sf))));
  Type_assign(&t_6.value[0], (&t_7), sizeof(struct Tuple2_EC3B57));
  Type_assign(MS_B5E3E6_at(r, art_Port_C61295_id_(building_control_BuildingControl_TempSensor_i_Bridge_currentTemp_(building_control_Arch_BuildingControlDemo_i_Instance_tempSensor(sf)))), (&t_6), sizeof(struct IS_AA0F82));
  ...
  Tuple2_EC3B57_apply(sf, &t_9, building_control_IPCPorts_Fan_i_App(sf), art_Port_69270F_id_(building_control_BuildingControl_Fan_i_Bridge_fanCmd_(building_control_Arch_BuildingControlDemo_i_Instance_fan(sf))));
  Type_assign(&t_8.value[0], (&t_9), sizeof(struct Tuple2_EC3B57));
  Type_assign(MS_B5E3E6_at(r, art_Port_69270F_id_(building_control_BuildingControl_TempControl_i_Bridge_fanCmd_(building_control_Arch_BuildingControlDemo_i_Instance_tcp_tempControl(sf)))), (&t_8), sizeof(struct IS_AA0F82));
  ...
  t_10.size = (int8_t) 2;
  t_10.value[0] = art_Port_69270F_id_(building_control_BuildingControl_Fan_i_Bridge_fanCmd_(building_control_Arch_BuildingControlDemo_i_Instance_fan(sf)));
  t_10.value[1] = art_Port_C61295_id_(building_control_BuildingControl_TempControl_i_Bridge_currentTemp_(building_control_Arch_BuildingControlDemo_i_Instance_tcp_tempControl(sf)));
  ...
  MS_2590FE_create((MS_2590FE) &t_13, sf, building_control_ArtNix_maxPortIds(sf), (Option_8E9F45) (&t_12));
...
Z building_control_ArtNix_maxPortIds(StackFrame caller) {
  building_control_ArtNix_init(caller);
...
Unit building_control_ArtNix_updateData(StackFrame caller, Z port, art_DataContent d) {
  ...
  Type_assign(MS_2590FE_at(building_control_ArtNix_data(sf), port), (&t_0), sizeof(union Option_8E9F45));
}
...
Unit building_control_ArtNix_receiveInput(StackFrame caller, IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(61);
  building_control_ArtNix_frozen_a(sf, (MS_2590FE) building_control_ArtNix_data(sf));
  ...
  sfUpdateLoc(62);
  {
    ...
    for (int8_t t_2 = 0; t_2 < t_1; t_2++) {
      ...
      sfUpdateLoc(63);
      Type_assign(MS_2590FE_at(building_control_ArtNix_data(sf), i), building_control_ArtNix_noData(sf), sizeof(union Option_8E9F45));
    }
  }
}
...
Unit building_control_ArtNix_sendOutput(StackFrame caller, IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(76);
  {
    ...
    for (int8_t t_7 = 0; t_7 < t_6; t_7++) {
      ...
      Type_assign(&t_0, MS_2590FE_at(building_control_ArtNix_outgoing(sf), p), sizeof(union Option_8E9F45));
      B match_77 = F;
      if (!match_77) {
        match_77 = T;
        ...
        if (match_77) {
          ...
          sfUpdateLoc(79);
          Type_assign(MS_2590FE_at(building_control_ArtNix_outgoing(sf), p), building_control_ArtNix_noData(sf), sizeof(union Option_8E9F45));

          sfUpdateLoc(80);
          {
            IS_AA0F82 t_2 = MS_B5E3E6_at(building_control_ArtNix_connection(sf), p);
            int8_t t_3 = (MS_B5E3E6_at(building_control_ArtNix_connection(sf), p))->size;
  ...
  sfUpdateLoc(87);
  {
    ...
    for (int8_t t_15 = 0; t_15 < t_14; t_15++) {
      ...
      Type_assign(&t_8, MS_2590FE_at(building_control_ArtNix_outgoing(sf), p), sizeof(union Option_8E9F45));
      B match_88 = F;
      if (!match_88) {
        match_88 = T;
        ...
        if (match_88) {
          ...
          sfUpdateLoc(91);
          {
            IS_AA0F82 t_10 = MS_B5E3E6_at(building_control_ArtNix_connection(sf), p);
            int8_t t_11 = (MS_B5E3E6_at(building_control_ArtNix_connection(sf), p))->size;
...
void building_control_ArtNix_dispatchStatus(art_DispatchStatus result, StackFrame caller, Z bridgeId) {
  ...
  sfUpdateLoc(49);
  if (building_control_ArtNix_isTimeDispatch(sf)) {
    Type_assign(result, building_control_ArtNix_timeTriggered(sf), sizeof(struct art_TimeTriggered));
  } else {
    ...
    sfUpdateLoc(53);
    {
      MS_30A5B4 t_2 = building_control_ArtNix_eventInPorts(sf);
      int8_t t_3 = (building_control_ArtNix_eventInPorts(sf))->size;
      for (int8_t t_4 = 0; t_4 < t_3; t_4++) {
        Z i = t_2->value[t_4];
        if (Option_8E9F45_nonEmpty_(sf, MS_2590FE_at(building_control_ArtNix_data(sf), i))) {
...
void building_control_ArtNix_getValue(Option_8E9F45 result, StackFrame caller, Z portId) {
  ...
  Type_assign(result, MS_2590FE_at(building_control_ArtNix_frozen(sf), portId), sizeof(union Option_8E9F45));
}
...
Unit building_control_ArtNix_putValue(StackFrame caller, Z portId, art_DataContent data) {
  ...
  Type_assign(MS_2590FE_at(building_control_ArtNix_outgoing(sf), portId), (&t_0), sizeof(union Option_8E9F45));
}