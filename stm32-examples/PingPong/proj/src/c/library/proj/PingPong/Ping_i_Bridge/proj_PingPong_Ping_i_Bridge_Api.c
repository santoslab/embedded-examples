...
Unit proj_PingPong_Ping_i_Bridge_Api_setping_out_(StackFrame caller, proj_PingPong_Ping_i_Bridge_Api this, proj_Base_Types_Integer_8 value) {
  DeclNewStackFrame(caller, "Ping_i_Bridge.scala", "proj.PingPong.Ping_i_Bridge.Api", "setping_out", 0);
...
void proj_PingPong_Ping_i_Bridge_Api_getping_inn_(Option_56AFA0 result, StackFrame caller, proj_PingPong_Ping_i_Bridge_Api this) {
  DeclNewStackFrame(caller, "Ping_i_Bridge.scala", "proj.PingPong.Ping_i_Bridge.Api", "getping_inn", 0);

  sfUpdateLoc(60);
  DeclNewOption_56AFA0(_value);
  Option_56AFA0 value = (Option_56AFA0) &_value;
  DeclNewOption_8E9F45(t_0);
  art_Art_getValue((Option_8E9F45) &t_0, sf, proj_PingPong_Ping_i_Bridge_Api_ping_inn_Id_(this));
