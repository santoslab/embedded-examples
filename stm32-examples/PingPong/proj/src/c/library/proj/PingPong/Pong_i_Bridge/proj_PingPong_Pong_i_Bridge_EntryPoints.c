...
void proj_PingPong_Pong_i_Bridge_EntryPoints_apply(StackFrame caller, proj_PingPong_Pong_i_Bridge_EntryPoints this, Z Pong_i_BridgeId, Z pong_inn_Id, Z pong_out_Id, proj_PingPong_Pong_i_Impl component) {
  ...
  t_1.size = (int8_t) 1;
  t_1.value[0] = proj_PingPong_Pong_i_Bridge_EntryPoints_pong_inn_Id_(this);
  ...
  t_3.size = (int8_t) 1;
  t_3.value[0] = proj_PingPong_Pong_i_Bridge_EntryPoints_pong_out_Id_(this);
...
Unit proj_PingPong_Pong_i_Bridge_EntryPoints_compute_(StackFrame caller, proj_PingPong_Pong_i_Bridge_EntryPoints this) {
  ...
  art_Art_dispatchStatus((art_DispatchStatus) &t_1, sf, proj_PingPong_Pong_i_Bridge_EntryPoints_Pong_i_BridgeId_(this));
  ...
  sfUpdateLoc(106);
  art_Art_receiveInput(sf, (IS_82ABD8) portIds, (IS_82ABD8) proj_PingPong_Pong_i_Bridge_EntryPoints_dataInPortIds_(this));
  ...
  sfUpdateLoc(108);
  {
    ...
    for (int8_t t_8 = 0; t_8 < t_7; t_8++) {
      ...
      sfUpdateLoc(110);
      if (Z__eq(portId, proj_PingPong_Pong_i_Bridge_EntryPoints_pong_inn_Id_(this))) {

        sfUpdateLoc(111);
        Option_8E9F45 t_3;
        DeclNewOption_8E9F45(t_4);
        art_Art_getValue((Option_8E9F45) &t_4, sf, proj_PingPong_Pong_i_Bridge_EntryPoints_pong_inn_Id_(this));
        ...
        sfUpdateLoc(112);
        proj_PingPong_Pong_i_Impl_handlepong_inn_(sf, proj_PingPong_Pong_i_Bridge_EntryPoints_component_(this), (proj_Base_Types_Integer_8) value);
      }
    }
  }
