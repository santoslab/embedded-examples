...
void proj_Arch_init(StackFrame caller) {
  ...
  art_Port_B84865_apply(sf, &t_2, Z_C(0), (String) string("PingPongSystem_i_Instance_p_ping_ping_inn"), art_PortMode_DataIn);
  DeclNewart_Port_B84865(t_3);
  art_Port_B84865_apply(sf, &t_3, Z_C(1), (String) string("PingPongSystem_i_Instance_p_ping_ping_out"), art_PortMode_DataOut);
  ...
  art_DispatchPropertyProtocol_Periodic_apply(sf, &t_5, Z_C(1000));
  DeclNewart_Port_B84865(t_6);
  art_Port_B84865_apply(sf, &t_6, Z_C(2), (String) string("PingPongSystem_i_Instance_p_pong_pong_inn"), art_PortMode_DataIn);
  DeclNewart_Port_B84865(t_7);
  art_Port_B84865_apply(sf, &t_7, Z_C(3), (String) string("PingPongSystem_i_Instance_p_pong_pong_out"), art_PortMode_DataOut);
