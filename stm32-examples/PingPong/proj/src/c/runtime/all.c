...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TNone_0A8767: return None_0A8767__eq((None_0A8767) t1, (None_0A8767) t2);
    ...
    case TSome_AA0E8F: return Some_AA0E8F__eq((Some_AA0E8F) t1, (Some_AA0E8F) t2);
    ...
    case Tart_Connection_4C277C: return art_Connection_4C277C__eq((art_Connection_4C277C) t1, (art_Connection_4C277C) t2);
    ...
    case Tart_Port_B84865: return art_Port_B84865__eq((art_Port_B84865) t1, (art_Port_B84865) t2);
    case TString: return String__eq((String) t1, (String) t2);
    case Tproj_Base_Types_Integer_8: return proj_Base_Types_Integer_8__eq((proj_Base_Types_Integer_8) t1, (proj_Base_Types_Integer_8) t2);
    case Tproj_Base_Types_Integer_8_Payload: return proj_Base_Types_Integer_8_Payload__eq((proj_Base_Types_Integer_8_Payload) t1, (proj_Base_Types_Integer_8_Payload) t2);
    case Tproj_PingPong_Ping_i_Bridge: return proj_PingPong_Ping_i_Bridge__eq((proj_PingPong_Ping_i_Bridge) t1, (proj_PingPong_Ping_i_Bridge) t2);
    case Tproj_PingPong_Ping_i_Bridge_Api: return proj_PingPong_Ping_i_Bridge_Api__eq((proj_PingPong_Ping_i_Bridge_Api) t1, (proj_PingPong_Ping_i_Bridge_Api) t2);
    case Tproj_PingPong_Ping_i_Bridge_EntryPoints: return proj_PingPong_Ping_i_Bridge_EntryPoints__eq((proj_PingPong_Ping_i_Bridge_EntryPoints) t1, (proj_PingPong_Ping_i_Bridge_EntryPoints) t2);
    case Tproj_PingPong_Ping_i_Impl: return proj_PingPong_Ping_i_Impl__eq((proj_PingPong_Ping_i_Impl) t1, (proj_PingPong_Ping_i_Impl) t2);
    case Tproj_PingPong_Pong_i_Bridge: return proj_PingPong_Pong_i_Bridge__eq((proj_PingPong_Pong_i_Bridge) t1, (proj_PingPong_Pong_i_Bridge) t2);
    case Tproj_PingPong_Pong_i_Bridge_Api: return proj_PingPong_Pong_i_Bridge_Api__eq((proj_PingPong_Pong_i_Bridge_Api) t1, (proj_PingPong_Pong_i_Bridge_Api) t2);
    case Tproj_PingPong_Pong_i_Bridge_EntryPoints: return proj_PingPong_Pong_i_Bridge_EntryPoints__eq((proj_PingPong_Pong_i_Bridge_EntryPoints) t1, (proj_PingPong_Pong_i_Bridge_EntryPoints) t2);
    case Tproj_PingPong_Pong_i_Impl: return proj_PingPong_Pong_i_Impl__eq((proj_PingPong_Pong_i_Impl) t1, (proj_PingPong_Pong_i_Impl) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TNone_0A8767: None_0A8767_cprint((None_0A8767) this, isOut); return;
    ...
    case TSome_AA0E8F: Some_AA0E8F_cprint((Some_AA0E8F) this, isOut); return;
    ...
    case Tart_Connection_4C277C: art_Connection_4C277C_cprint((art_Connection_4C277C) this, isOut); return;
    ...
    case Tart_Port_B84865: art_Port_B84865_cprint((art_Port_B84865) this, isOut); return;
    case TString: String_cprint((String) this, isOut); return;
    case Tproj_Base_Types_Integer_8: proj_Base_Types_Integer_8_cprint((proj_Base_Types_Integer_8) this, isOut); return;
    case Tproj_Base_Types_Integer_8_Payload: proj_Base_Types_Integer_8_Payload_cprint((proj_Base_Types_Integer_8_Payload) this, isOut); return;
    case Tproj_PingPong_Ping_i_Bridge: proj_PingPong_Ping_i_Bridge_cprint((proj_PingPong_Ping_i_Bridge) this, isOut); return;
    case Tproj_PingPong_Ping_i_Bridge_Api: proj_PingPong_Ping_i_Bridge_Api_cprint((proj_PingPong_Ping_i_Bridge_Api) this, isOut); return;
    case Tproj_PingPong_Ping_i_Bridge_EntryPoints: proj_PingPong_Ping_i_Bridge_EntryPoints_cprint((proj_PingPong_Ping_i_Bridge_EntryPoints) this, isOut); return;
    case Tproj_PingPong_Ping_i_Impl: proj_PingPong_Ping_i_Impl_cprint((proj_PingPong_Ping_i_Impl) this, isOut); return;
    case Tproj_PingPong_Pong_i_Bridge: proj_PingPong_Pong_i_Bridge_cprint((proj_PingPong_Pong_i_Bridge) this, isOut); return;
    case Tproj_PingPong_Pong_i_Bridge_Api: proj_PingPong_Pong_i_Bridge_Api_cprint((proj_PingPong_Pong_i_Bridge_Api) this, isOut); return;
    case Tproj_PingPong_Pong_i_Bridge_EntryPoints: proj_PingPong_Pong_i_Bridge_EntryPoints_cprint((proj_PingPong_Pong_i_Bridge_EntryPoints) this, isOut); return;
    case Tproj_PingPong_Pong_i_Impl: proj_PingPong_Pong_i_Impl_cprint((proj_PingPong_Pong_i_Impl) this, isOut); return;
    default: fprintf(stderr, "%s: %d\n", "Unexpected TYPE: ", type); exit(1);
  }
  #endif
}
...
void Type_string(String result, StackFrame caller, void *this) {
  ...
  switch (type) {
    ...
    case TNone_0A8767: None_0A8767_string(result, caller, (None_0A8767) this); return;
    ...
    case TSome_AA0E8F: Some_AA0E8F_string(result, caller, (Some_AA0E8F) this); return;
    ...
    case Tart_Connection_4C277C: art_Connection_4C277C_string(result, caller, (art_Connection_4C277C) this); return;
    ...
    case Tart_Port_B84865: art_Port_B84865_string(result, caller, (art_Port_B84865) this); return;
    case TString: String_string(result, caller, (String) this); return;
    case Tproj_Base_Types_Integer_8: proj_Base_Types_Integer_8_string(result, caller, (proj_Base_Types_Integer_8) this); return;
    case Tproj_Base_Types_Integer_8_Payload: proj_Base_Types_Integer_8_Payload_string(result, caller, (proj_Base_Types_Integer_8_Payload) this); return;
    case Tproj_PingPong_Ping_i_Bridge: proj_PingPong_Ping_i_Bridge_string(result, caller, (proj_PingPong_Ping_i_Bridge) this); return;
    case Tproj_PingPong_Ping_i_Bridge_Api: proj_PingPong_Ping_i_Bridge_Api_string(result, caller, (proj_PingPong_Ping_i_Bridge_Api) this); return;
    case Tproj_PingPong_Ping_i_Bridge_EntryPoints: proj_PingPong_Ping_i_Bridge_EntryPoints_string(result, caller, (proj_PingPong_Ping_i_Bridge_EntryPoints) this); return;
    case Tproj_PingPong_Ping_i_Impl: proj_PingPong_Ping_i_Impl_string(result, caller, (proj_PingPong_Ping_i_Impl) this); return;
    case Tproj_PingPong_Pong_i_Bridge: proj_PingPong_Pong_i_Bridge_string(result, caller, (proj_PingPong_Pong_i_Bridge) this); return;
    case Tproj_PingPong_Pong_i_Bridge_Api: proj_PingPong_Pong_i_Bridge_Api_string(result, caller, (proj_PingPong_Pong_i_Bridge_Api) this); return;
    case Tproj_PingPong_Pong_i_Bridge_EntryPoints: proj_PingPong_Pong_i_Bridge_EntryPoints_string(result, caller, (proj_PingPong_Pong_i_Bridge_EntryPoints) this); return;
    case Tproj_PingPong_Pong_i_Impl: proj_PingPong_Pong_i_Impl_string(result, caller, (proj_PingPong_Pong_i_Impl) this); return;
    default: fprintf(stderr, "%s: %d\n", "Unexpected TYPE: ", type); exit(1);
  }
}
